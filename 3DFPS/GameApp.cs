...
namespace _3DFPS
{
    ...
    {
        private const int ScreenWidth = 190;
        ...
        static async Task Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                //_playerA += 0.5 * elapsedTime; // For testing the 3D


                // Ray casting
                List<Task<Dictionary<int, char>>> rayCastingTasks = new List<Task<Dictionary<int, char>>>();
        ...
        public static Dictionary<int, char> CastRay(int x)
        {
            ...
            while (!hitWall && distanceToWall < Depth)
            {
                ...
                else
                {
                    ...
                    //}
                    // This else statement does not work properly for some reason.
                }
            }
